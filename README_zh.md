...
# Skill-hub - 面向 Codex 与 Claude Code 的 AI Agent 技能库

Skill-hub 是一个公开的 `SKILL.md` 工作流与提示词技能集合，面向 OpenAI Codex、Claude Code、Antigravity 等 AI 编码 Agent；当前包含 **59** 个可复用技能，按共享技能和项目私有技能组织，便于检索、本地同步与复用。

**搜索意图：** Agent 技能库、AI 编码 Agent 技能、Codex 技能、Claude Code 技能、提示词工作流、skill hub、`SKILL.md` 模板。
...
**边界说明：** 这是个人展示与学习仓库，不是 OpenAI、Anthropic、Claude Code 或 Antigravity 官方技能库。仓库公开，请只使用占位符填写凭据，不要提交真实密钥或隐私数据。
